      ...
      >
        ...
        >
          <Icon
            ...
            onClick={() =>
              window.open(
                "https://www.linkedin.com/in/sebastian-hoberg-ba2a77140/"
              )
            }
          />
          <Icon
            ...
            boxSize="50"
            cursor="pointer"
            onClick={() => window.open("https://github.com/sehob2020")}
          />
          <Icon
            as={FaFacebookF}
            boxSize="50"
          ...
          <Icon
            ...
            boxSize="50"
            cursor="pointer"
            onClick={() => window.open("mailto:hoberg.sebastian@gmail.com")}
          />
        </HStack>
      </motion.div>
    </VStack>
